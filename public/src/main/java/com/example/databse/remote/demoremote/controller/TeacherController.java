...
import com.example.databse.remote.demoremote.object.Sem4;
...
public String createstudent(@RequestParam String rollNo, @RequestParam String name,@RequestParam String age, @RequestParam String city, @RequestParam String gender, @RequestParam MultipartFile file,@RequestParam String ca ,@RequestParam String aca,@RequestParam String edg,@RequestParam String c,@RequestParam String daa,@RequestParam String maths, @RequestParam String dsa, @RequestParam String os,@RequestParam String cd, @RequestParam String at, @RequestParam String java, @RequestParam String python,@RequestParam String ds, @RequestParam String cn, @RequestParam String dbms, @RequestParam String english, Model model) throws InterruptedException, ExecutionException{  
	...
	String path;
	 ...
	 Result result=new Result(new Sem1(ca, aca, edg, c), new Sem2(daa, maths, dsa, os), new Sem3(cd, at, java, python), new Sem4(ds, cn, dbms, english));
	 Student s=new Student(rollNo,name,age,city,gender,path,result);
...
public String updateLast(@PathVariable String rollNo,@RequestParam String name, @RequestParam String age,@RequestParam String city,@RequestParam MultipartFile file,Model model,@RequestParam String ca ,@RequestParam String aca,@RequestParam String edg,@RequestParam String c,@RequestParam String daa,@RequestParam String maths, @RequestParam String dsa, @RequestParam String os,@RequestParam String cd, @RequestParam String at, @RequestParam String java, @RequestParam String python,@RequestParam String ds, @RequestParam String cn, @RequestParam String dbms, @RequestParam String english) throws InterruptedException, ExecutionException 
{
	String path;
	if(file.isEmpty())
	...
	model.addAttribute("message",studentService.updateStudentDetails(rollNo, name, age, city, gender, path,ca,aca,edg,c,daa,maths,dsa,os,cd,at,java,python,ds,cn,dbms,english));
	model.addAttribute("student",studentService.getStudentDetails(rollNo));
