    ...
    try {
      ...
      pdfWriter.getDirectContentUnder()
       ...
       p4.setAlignment(Paragraph.ALIGN_CENTER);
        ...
        Paragraph p9=new Paragraph("Sessional 1 Result..",f);
        p9.setAlignment(Paragraph.ALIGN_CENTER);
        PdfPCell cell1 = new PdfPCell(new Paragraph("Computer Architecture",f));
        PdfPCell cell2 = new PdfPCell(new Paragraph("Unix-Linux Programming",f));
        PdfPCell cell3 = new PdfPCell(new Paragraph("Computer Network",f));
        PdfPCell cell4 = new PdfPCell(new Paragraph("Compiler Design",f));
        ...
        Paragraph p10=new Paragraph("Sessional 2 Result..",f);
        p10.setAlignment(Paragraph.ALIGN_CENTER);
        PdfPCell cell9 = new PdfPCell(new Paragraph("Advanced Computer Architecture",f));
        PdfPCell cell10 = new PdfPCell(new Paragraph("Unix-Linux Programming",f));
        PdfPCell cell11= new PdfPCell(new Paragraph("Computer Network",f));
        PdfPCell cell12 = new PdfPCell(new Paragraph("Compiler Design",f));
        ...
        Paragraph p11=new Paragraph("Sessional 3 Result..",f);
        p11.setAlignment(Paragraph.ALIGN_CENTER);
        PdfPCell cell17 = new PdfPCell(new Paragraph("Advanced Computer Architecture",f));
        PdfPCell cell18 = new PdfPCell(new Paragraph("Unix-Linux Programming",f));
        PdfPCell cell19 = new PdfPCell(new Paragraph("Computer Network ",f));
        PdfPCell cell20 = new PdfPCell(new Paragraph("Compiler Design",f));
